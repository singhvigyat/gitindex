...
async function main() {
    ...
    const input = path.resolve(__dirname, `orgs_${process.env.YEAR}_github_filtered.json`);

    const output = path.resolve(__dirname, `orgs_${process.env.YEAR}_google_filtered.json`);
